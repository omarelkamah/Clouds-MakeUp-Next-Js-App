...
const Product = ({ id, name, price, image, category }) => {
  return (
    <Link href={`/product/${id}`}>
      <div className='flex w-[250px] flex-col align-center cursor-pointer rounded-md mb-6 sm:mr-6 px-4 py-6 transform hover:scale-105 hover:shadow-xl transition delay-50 duration-300 ease-in-out'>
